...
#define _XTAL_FREQ                  20000000   //to use built in delay function we need clock frequency
#define LINE1(x)					(0x80 + (x)) //to access each position in the line 1 by incrementing x
